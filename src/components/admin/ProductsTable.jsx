                    ...
                    <tbody>
                        {
                            products && products.map((product) => (
                                <tr key={product.$id} className='text-black'>
                                    ...
                                    <td className='pl-2 border-x-black border text-white transition-all duration-200'>{product.productPrice}</td>
                                    <td className='pl-2 border-x-black border text-white transition-all duration-200'>{product.categoryId}</td>
                                    <td className='pl-2 border-x-black border text-white transition-all duration-200'>{product.productQuantity}</td>
                                    <td className='pl-2 border-x-black border text-white transition-all duration-200'>{product.productStatus ? 'active' : 'in-active'}</td>
                                    <td className='pl-2 border-x-black border text-white transition-all duration-200'>{product.featured ? 'Yes' : 'No'}</td>
                                    <td className='pl-2 border-x-black border text-white transition-all duration-200'>{product.new ? 'Yes' : 'No'}</td>

...
const Admin = () => {
    ...
    const [toaster, setToaster] = useState({ message: 'Welcome to admins dashboard', type: 'info', duration: 2000 })
    return (
        <>
            <AdminToastComponent message={toaster.message} iconType={toaster.type} duration={toaster.duration} />

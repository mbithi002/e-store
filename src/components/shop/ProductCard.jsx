...
function ProductCard({ image = 'image', name = 'product', description = '', price = 0, rating = 0, stock = 'in stock' }) {
  return (
    <div className="card sm:w-[190px] w-[260px] sm:my-1 my-2 shadow-md h-[340px] p-2 m-2 bg-[#f5f5f5] relative overflow-visible shadow-md mx-auto">
      ...
      <div className="card-info pt-[5%]">
        <p className="text-title font-black text-[1.2em] leading-6">{name}</p>
        <p className="text-body text-[0.9em] pb-2.5">{description}</p>
      </div>
      <div className="card-footer w-full flex justify-between items-center pt-2.5 mb-1 border-t border-[#ddd] gap-2">
        <span className="text-title font-black text-[1.2em] leading-6">${price}</span>
        ...
        <div className="card-button border border-[#252525] flex p-1.2 cursor-pointer rounded-full transition-all duration-300 ease-in-out">
